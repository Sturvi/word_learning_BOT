...
public class Api {
    ...
    /**
     * Метод для получения ответа на вопрос, связанный с изучением английского языка.
     * Если вопрос не связан с изучением английского языка, метод вернет "false".
     *
     * @param question Вопрос, переданный в виде строки.
